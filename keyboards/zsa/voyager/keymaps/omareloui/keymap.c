...
[SYM] = LAYOUT(
  ...
  _______ , KC_CIRC , KC_LABK , KC_LBRC , KC_DQUO , KC_QUOT ,                         KC_PLUS , KC_AMPR , KC_RBRC , KC_RABK , KC_DLR  , _______,
  _______ , KC_EQL  , KC_LPRN , KC_LCBR , MAGIC   , KC_SLSH ,                         KC_BSLS , KC_TILD , KC_RCBR , KC_RPRN , KC_SCLN , _______,
  _______ , KC_AT   , KC_DOT  , KC_COMM , KC_PERC , KC_HASH ,                         KC_ASTR , KC_PIPE , KC_QUES , KC_EXLM , KC_COLN , _______,
